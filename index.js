 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`primeaicore-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`primeaicore-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'primeaicore-' + name : 'primeaicore';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/primeaicore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external primeaicore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:primeaicore-lib -o primeaicore-lib.js';
    }
